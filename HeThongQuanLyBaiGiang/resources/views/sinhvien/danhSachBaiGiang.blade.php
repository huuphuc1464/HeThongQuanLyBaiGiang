        ...
        <div class="card-body">
            <div class="accordion" id="chuong">
                <div class="mb-4">
                    ...
                    <p>Tên bài giảng: {{ $baiGiang->TenBaiGiang }}.</p>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading-{{ $baiId }}">
                                        <button class="accordion-button collapsed fw-bold text-dark bg-light"
                                            ...
                                            data-bs-target="#collapse-{{ $baiId }}" aria-expanded="false"
                                            aria-controls="collapse-{{ $baiId }}">
                                            {{ $tenBai }}
                                        </button>
                                    </h2>
                                    <div id="collapse-{{ $baiId }}" class="accordion-collapse collapse show"
                                        aria-labelledby="heading-{{ $baiId }}" data-bs-parent="#bai-{{ $chuongId }}">
                                        <div class="accordion-body">
                                            <ul class="list-group">
                                                    ...
                                                    <a href="{{ route('bai.chi-tiet', ['id' => $id, 'maBaiGiang' => $baiGiang->MaBaiGiang]) }}"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span class="text-muted">
                                                                ...
                                                                {{
                                                                \Carbon\Carbon::parse($baiGiang->updated_at)->format('H:i:s
                                                                d/m/Y') }}
                                                            </span>
                                                        </div>
                                                    </a>
