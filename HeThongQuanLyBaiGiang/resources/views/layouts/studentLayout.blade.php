    ...
    <nav class="navbar navbar-expand-lg bg-white border-bottom px-3 fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand d-flex align-items-center gap-2" href="/">
                <img class="logo-img" alt="Website logo placeholder image" height="24" src="{{asset('/img/web/logo.jpg')}}" width="30" />
        ...
        <form action="{{ url()->current() }}" method="GET" class="d-flex me-auto mx-lg-auto my-2 my-lg-0 flex-grow-1 justify-content-end justify-content-lg-center px-3" role="search" style="max-width: 600px;">
            <div class="position-relative w-100">
                <input class="form-control rounded-pill" type="search" name="search" placeholder="{{ $placeholder }}" aria-label="Search" value="{{ request('search') }}" />
