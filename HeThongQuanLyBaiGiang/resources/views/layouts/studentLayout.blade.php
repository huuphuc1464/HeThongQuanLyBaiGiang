    ...
    <nav class="navbar navbar-expand-lg bg-white border-bottom px-3 fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="anHienNavbar">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu dropend">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-truncate" href="{{ route('trang-chu', ['giang_vien' => $gv['MaGiangVien'], 'mon_hoc' => $mon['MaMonHoc']]) }}">{{ $gv['TenGiangVien']
                                                    }}
                                                </a>
                                            </li>
                                            @endforeach
                ...
                {{-- Giữa: Search --}}
                <form action="{{ route('trang-chu') }}" method="GET" class="d-flex me-auto mx-lg-auto my-2 my-lg-0 flex-grow-1 justify-content-end justify-content-lg-center px-3" role="search" style="max-width: 600px;">
                    <div class="position-relative w-100">
                        <input class="form-control rounded-pill" type="search" name="search" placeholder="Tìm kiếm theo lớp học phần, học phần, giảng viên, ..." aria-label="Search" />
