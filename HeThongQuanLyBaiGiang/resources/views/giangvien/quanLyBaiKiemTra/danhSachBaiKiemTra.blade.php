...
<div class="container-fluid py-4">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('giangvien.bai-kiem-tra.form-them') }}" class="btn btn-success">
                        ...
                        <tr>
                            ...
                            <td class="text-center action-buttons">
                                <div class="btn-group">
                                    ...
                                    <a href="#" class="btn btn-sm btn-primary" title="Xuất kết quả">
                                        <i class="fas fa-download"></i>
                                    </a>
                                    <a href="#" class="btn btn-sm btn-secondary" title="Xuất bài kiểm tra">
