        ...
        <div class="card-header">
            <div class="row w-100 align-items-center">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#importBaiKiemTra" title="Import bài kiểm tra bằng file Excel">
                        <i class="fas fa-file-import"></i> Import
                    </button>
                    <a class="btn btn-warning" href="{{ asset('./BaiKiemTra/Template_Import_BaiKiemTra.xlsx') }}" download title="Tải mẫu Excel">
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-between mb-3">
                <div class="col-md-auto">
                    <form method="GET" action="{{ route('giangvien.bai-kiem-tra.danh-sach') }}" class="d-flex align-items-center">
                ...
                <div class="col-md-auto">
                    <form method="GET" action="{{ route('giangvien.bai-kiem-tra.danh-sach') }}" class="d-flex align-items-center">
                        ...
                        <select name="filterClass" id="filterClass" class="form-select form-select-sm" onchange="this.form.submit()">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center action-buttons">
                                <div class="btn-group">
                                    <a href="{{ route('giangvien.bai-kiem-tra.chi-tiet', $baiKiemTra->MaBaiKiemTra) }}" class="btn btn-sm btn-info" title="Xem chi tiết">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('giangvien.bai-kiem-tra.form-sua', $baiKiemTra->MaBaiKiemTra) }}" class="btn btn-sm btn-primary" title="Sửa">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $baiKiemTra->MaBaiKiemTra }}" title="Xóa">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <a href="{{ route('giangvien.bai-kiem-tra.xuat-ket-qua', ['id' => $baiKiemTra->MaBaiKiemTra]) }}" class="btn btn-sm btn-primary" title="Xuất kết quả bài làm của sinh viên">
                                        <i class="fas fa-download"></i>
                                    </a>
                                    <a href="{{ route('giangvien.bai-kiem-tra.xuat-bai-kiem-tra', ['id' => $baiKiemTra->MaBaiKiemTra]) }}" class="btn btn-sm btn-secondary" title="Xuất bài kiểm tra">
                                        <i class="fas fa-file-export"></i>
                                    </a>
                                    <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#duplicateModal{{ $baiKiemTra->MaBaiKiemTra }}" title="Nhân bản">
                        ...
                        <!-- Modal Xóa -->
                        <div class="modal fade" id="deleteModal{{ $baiKiemTra->MaBaiKiemTra }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $baiKiemTra->MaBaiKiemTra }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('giangvien.bai-kiem-tra.xoa', $baiKiemTra->MaBaiKiemTra) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <!-- Modal Nhân bản -->
                        <div class="modal fade" id="duplicateModal{{ $baiKiemTra->MaBaiKiemTra }}" tabindex="-1" aria-labelledby="duplicateModalLabel{{ $baiKiemTra->MaBaiKiemTra }}" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('giangvien.bai-kiem-tra.nhan-ban') }}" method="POST">
                                            @csrf
                                            @method('')
                                            <input type="hidden" name="MaBaiKiemTra" value="{{ $baiKiemTra->MaBaiKiemTra }}">
                                            <div class="mb-3">
                                                <label for="duplicateClass{{ $baiKiemTra->MaBaiKiemTra }}" class="form-label">Chọn lớp học phần đích <span class="text-danger">*</span></label>
                                                <select class="form-select @error('MaLopHocPhan') is-invalid @enderror" id="duplicateClass{{ $baiKiemTra->MaBaiKiemTra }}" name="MaLopHocPhan" required>
                                            ...
                                            <div class="mb-3">
                                                <label for="status{{ $baiKiemTra->MaBaiKiemTra }}" class="form-label">Trạng thái</label>
                                                <select class="form-select" name="TrangThai" id="status{{ $baiKiemTra->MaBaiKiemTra }}">
...
<div class="modal fade" id="importBaiKiemTra" tabindex="-1" aria-labelledby="importBaiKiemTraModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{ route('giangvien.bai-kiem-tra.import') }}" method="POST" enctype="multipart/form-data" class="modal-content p-4">
            @csrf
            <div class="modal-header">
